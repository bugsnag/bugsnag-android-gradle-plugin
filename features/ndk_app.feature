...
Scenario: NDK apps send requests
    ...
    And the payload field "projectRoot" ends with "features/fixtures/ndkapp/app_agp340" for request 1
    ...
    And the payload field "projectRoot" ends with "features/fixtures/ndkapp/app_agp340" for request 2
    ...
    And the payload field "projectRoot" ends with "features/fixtures/ndkapp/app_agp340" for request 3
    ...
    And the payload field "projectRoot" ends with "features/fixtures/ndkapp/app_agp340" for request 4
