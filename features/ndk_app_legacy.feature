...
Scenario: NDK app only uploads SO file matching architecture for ABI splits
    ...
    And the payload field "versionCode" equals "5" for request 13

    And the request 12 is valid for the Android Mapping API
    And the payload field "versionCode" equals "4" for request 12

    And the request 11 is valid for the Android Mapping API
    And the payload field "versionCode" equals "1" for request 11
    ...
    And the payload field "arch" equals "armeabi-v7a" for request 8

    And the request 9 is valid for the Android NDK Mapping API
    And the payload field "arch" equals "x86" for request 9

    And the request 10 is valid for the Android NDK Mapping API
    And the payload field "arch" equals "x86_64" for request 10

    And the request 6 is valid for the Android Mapping API
    And the payload field "versionCode" equals "3" for request 6

    And the request 5 is valid for the Android Mapping API
    And the payload field "versionCode" equals "2" for request 5
    ...
    And the payload field "appVersionCode" equals "4" for request 3
