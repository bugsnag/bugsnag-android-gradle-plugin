...
Scenario: Flavor Density Split project builds successfully
    ...
    And the payload field "appVersionCode" equals "2" for request 11
    ...
    And the payload field "appVersionCode" equals "3" for request 9

    And the request 8 is valid for the Build API
    And the payload field "appVersionCode" equals "2" for request 8
    ...
    And the payload field "appVersionCode" equals "3" for request 6
    ...
    And the field "versionCode" for multipart request 3 equals "3"
    ...
    And the field "appId" for multipart request 2 equals "com.bugsnag.android.example.foo"
